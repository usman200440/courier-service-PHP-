            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">View All Agents</h1>
<hr>
...
while($row=mysqli_fetch_assoc($result))
{
    ...
    <tr>
      ...
      <td>'.$row['contact'].'</td>
      <td>'.$row['branch']."</td>
      <td class='a1abt'><a href='upgrade.php? id1=$row[id] & name1=$row[user_name]
      & email1=$row[email] & contact1=$row[contact]' class='abt1'>Edit</a></td>
      <td class='a2abt'><a href='delete.php? id=$row[id]' class='abt2'>Delete</a></td>
    </tr>";
}
?>
</tbody>
...
<br>
<p class="CSR">All Agents is defined by '3' number</p>
