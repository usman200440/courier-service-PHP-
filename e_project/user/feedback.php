...
if($same=($_SESSION['sAddress']==$_SESSION['rAddress']))
{
...
<body class="bg-dark">
    ...
    <div class="container-fluid overflow-hidden py-5 px-lg-0">
        <h1 class="mb-3 text-secondary">feedback</h1>
                ...
                <div class="col-md-12 contact-form wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <form action="billinfo.php" method="POST">
                            <div class="row g-3 bg-dark">
                                <div class="col-12 mb-5 border-4 bg-secondary">
                                    <div class="form-floating">
                                        <textarea class="form-control bg-dark border-0 text-white" placeholder="Leave a message here" id="message" style="height: 100%" name="feedback"></textarea>
                                        <label for="message" class="text-secondary">Message</label>
                                    </div>
                                </div>
                                <input class="btn btn-secondary w-100 py-3 text-dark" name="submit4" type="submit" value="Finish">
                                </div>
                            </div>
                        </form>
