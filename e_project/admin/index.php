...
?>
<?php
$select="SELECT * FROM `sign_in_up` WHERE roles=1";
                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fas fa-columns ic"></i> Agent </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="Cagent.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fas fa-box ic"></i> All Courier </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fas fa-user ic"></i> OverALL Users </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="alluser.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
...
<hr>
<h2 class="CSR">OverALL Admins</h2>
