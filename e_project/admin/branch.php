...
if(isset($_POST['register'])){
  ...
  $city=$_POST['city'];
  $query2="INSERT INTO `branch`(`id`, `b_address`, `b_city`)
   VALUES (null,'$address','$city')";
   mysqli_query($connect,$query2);
}

$query1="SELECT `id`, `name` FROM `city`";
$select1=mysqli_query($connect,$query1);

$query3="SELECT `id`, `b_address`, `b_city` FROM `branch`";
...
<hr>
                            ...
                            <a class="nav-link active" href="branch.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Branch</h1>
<hr>
              ...
              <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="text" name="address" class="form-control form-control-lg fieldAg" placeholder="Enter Address of New Branch" required> 
                  </div>
...
<br>
              <div class="row">
                <div class="col-md-12 mb-4">
                  ...
                  <div class="form-outline">
                    <input type="number" name="city" min='1' max='5' class="form-control form-control-lg fieldAg" placeholder="Enter City ID" required>
                  </div>
...
<h2 class="CSR">OverALL Branches</h2>
...
<!-- form end -->
<h4 class="CSR">City is Defined by ID</h4>
