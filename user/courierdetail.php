...
<body class="bg-dark">
    ...
    <div class="container-fluid overflow-hidden py-5 px-lg-0">
        <h1 class="mb-5 text-secondary">Parcel Information</h1>
                    ...
                    <div class="p-4 bg-dark">
                        <form action="sender.php" method="POST">
                            ...
                            <div class="row g-3 bg-dark">
                                <div class="col-12 mb-4 border-4 bg-secondary ">
                                    <div class="form-floating">
                                        <input type="text" name="parcelName" class="form-control bg-dark border-0 text-secondary"  id="name" pattern="[A-Za-z]+[a-z]" title="only first alphabet allowed in uppercase" required>
                                        <label for="name" class="text-white">Parcel Name</label>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-4 border-4 bg-secondary">
                                    <div class="form-floating">
                                        <input type="number" name="weight" min="20" class="form-control bg-dark border-0 text-secondary" id="name" required>
                                        <label for="name" class="text-white">Weight</label>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-4 border-4 bg-secondary">
                                    <div class="form-floating">
                                        <input type="number" name="height" min="5" class="form-control bg-dark border-0 text-secondary" id="name" required>
                                        <label for="name" class="text-white">Height</label>
                                    </div>
                                </div>
                                <input class="btn btn-secondary w-100 py-3 text-dark" name="submit1" type="submit" value="Next Step">
                                </div>
                            </div>
                        </form>
