...
{
echo '<script>alert("both address are same change one address please")</script>';
unset($_SESSION['same']);
}


if(isset($_POST['submit1'])){
    $_SESSION['p_name']=$_POST['parcelName'];
...
<body class="bg-dark">
    ...
    <div class="container-fluid overflow-hidden py-5 px-lg-0">
        <h1 class="mb-3 text-secondary">Sender Information</h1>
                            ...
                            <div class="row g-3 bg-dark">
                                <div class="col-12 mb-3 border-4 bg-secondary ">
                                    <div class="form-floating">
                                        <input type="text" name="senderName" value="<?php echo $_SESSION['name']?>" class="form-control bg-dark border-0 text-secondary" id="name"  required readonly>
                                        <label for="name" class="text-white">Sender Name</label>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3 border-4 bg-secondary">
                                    <div class="form-floating">
                                        <input type="email" name="email" class="form-control bg-dark border-0 text-secondary" id="name" pattern="[A-Za-z]{0,20}+[1-9]{0,20}+@gmail.com" title="@gmail.com e.g Nadir12@gmail.com" required>
                                        <label for="name" class="text-white">Email</label>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-3 border-4 bg-secondary">
                                    <div class="form-floating">
                                        <input type="tel" name="contact" pattern="[0-9]{4}-[0-9]{7}" class="form-control bg-dark border-0 text-secondary" id="name" required>
                                        <label for="name" class="text-white">Contact</label>
                                    </div>
                                </div>
                                <div class="col-12 mb-3 border-4 bg-secondary ">
                                    <div class="form-floating">
                                        <input type="text" name="sAddress" class="form-control bg-dark border-0 text-secondary" id="name" pattern="[A-Za-z]\w{0,10}[0-9]\d{0,10}-[A-Za-z]\w{0,50}" title="HomeAddress-city e.g k21-karachi" required>
                                        <label for="name" class="text-white">Address</label>
                                    </div>
                                </div>
                                <div class="col-12 mb-3 border-4 bg-secondary ">
                                    <div class="form-floating">
                                        <h6>Select Branch  <i class="fas fa-angle-down"></i></h6>
                                          <select name="branch" class="form-control bg-dark border-0 text-secondary" id="name" placeholder="branch" required>
                                ...
                                <input class="btn btn-secondary w-100 py-3 text-dark" name="submit2" type="submit" value="Next Step">
                                </div>
                            </div>
                        </form>
