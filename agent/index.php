                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fa-solid fa-gauge ic"></i> Dashboard </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="index.php">View Details</a>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fas fa-columns ic"></i>Shipment</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="manageship.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fas fa-book-open ic"></i> New Courier </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="createbill.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fa-solid fa-file ic"></i> Reports </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="report.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6">
                                <div class="card   mb-4">
                                    <div class="card-body"><i class="fas fa-message ic"></i> Status </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="status.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-xl-4 col-md-6">
                                <div class="card  mb-4">
                                    <div class="card-body"><i class="fas fa-comment ic"></i> Feedback </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small stretched-link" href="feedback.php">View Details</a>
                                        <div class="small"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
...
<div class="row">
<div class="col-sm-6">
<a href="msg.php" class="a4abt">MESSAGE BOX</a>
</div>
</div>
                </div>
...
<p class="CSR">Use the agent dashboard to manage your status in assigned queues, view high-level queue activity, ... Create and use pre-saved text messages — Complete only.</p>
